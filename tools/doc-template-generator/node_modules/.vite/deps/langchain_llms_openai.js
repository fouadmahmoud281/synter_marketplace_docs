...
} from "./chunk-3AYGQHDU.js";
import "./chunk-XE6MPREY.js";
import {
  BaseLangChain,
  BaseLanguageModel,
  GenerationChunk,
...
var OpenAI2 = class extends BaseLLM {
  ...
  constructor(fields, configuration) {
    ...
    this.azureOpenAIApiKey = (fields == null ? void 0 : fields.azureOpenAIApiKey) ?? getEnvironmentVariable("AZURE_OPENAI_API_KEY");
    this.azureADTokenProvider = (fields == null ? void 0 : fields.azureADTokenProvider) ?? void 0;
...
var PromptLayerOpenAIChat = class extends OpenAIChat {
  ...
  constructor(fields) {
    ...
    this.promptLayerApiKey = (fields == null ? void 0 : fields.promptLayerApiKey) ?? getEnvironmentVariable("PROMPTLAYER_API_KEY");
...
var PromptLayerOpenAI = class extends OpenAI2 {
  get lc_secrets() {
    return {
      promptLayerApiKey: "PROMPTLAYER_API_KEY"
    };
...
//# sourceMappingURL=langchain_llms_openai.js.map
